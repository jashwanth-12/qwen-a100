...
# venv lives in the heavy folder (kept off-laptop); scripts live in the code
# folder. Don't cd — source this from wherever the user invoked it.
source /data/users/jashwanth/qwen-claude/venv/bin/activate
